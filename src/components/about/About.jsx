            ...
            <div id="wrapper-about">
                ...
                <div id="presentation-about">
                    ...
                    <div id="presentation-about-text">
                        ...
                        <p>
                            Depuis toujours, l'informatique m'as naturellement attiré de par son accéssibilité, son environnement riche et complexe, et ses possibilités créatives en tout genre. Parmis elle, il y'a le développement web, qui nourrit en moi un besoin de construire et résoudre des problématiques de façon varié et technique tout en laissant place à mon imagination. Tout est possible dans l'univers du web, on peut changer le monde, y créer les projets les plus fou, comme les plus simple, les plus utiles ou originaux... C'est un 'métier passion', c'est ma passion !<br/>
                            Titulaire d'un BTS IRIS (informatique et réseaux pour l'industrie et les services), cette formation m'a donné de bonne base en algorithmie et programmation (C/C++) ainsi qu'en analyse et conception qui m'a permit de mieux evoluer dans le développement web.<br/>  
                            J'ai une affinité particulière pour le design, l'interface et l'expérience utilisateur. J'aime intégrer un visuel et imaginer la navigation de l'internaute. Mais je peux tout aussi bien faire du développement back-end avec une forte expérience en Symfony comme vous pourrez le voir dans mes réalisations. Je suis ouvert à collaborer sur toute sorte de projets qui ne sont pas forcément dans mon domaine de compétence tel que Node.js côté back-end ou encore Angular pour le Front-end, je suis curieux et enthousiaste d'appréhender et maitriser d'autres technologies. 

...
const portfolio = [
    {   
        ...
        techs: "React",
        sum: "In this challenge, you'll be building a 4-page site that will look great in any portfolio. You'll even get the chance to play with mapping APIs if you choose the bonus.",
        path: "",
    },
    {   

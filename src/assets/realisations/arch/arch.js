        ...
        specs: [
            ...
            },
            {
                ...
                sections: [
                    {
                        paragraphe: [
                            "<a href='https://swiperjs.com/' target='_blank' rel='noreferrer'>Swiper</a> est une bibliothèque moderne, puissante, optimisée et performante, pour créer un slider (diaporama ou glissière qui permet de faire défiler un élément graphique avec le curseur) rapidement et qui s'intègre très bien à React sous forme de composants, sans module supplémentaire car Swiper/React utilise la version principale de Swiper. De plus la <a href='https://swiperjs.com/react' target='_blank' rel='noreferrer'>documentation</a> est très bien faites. Swiper répond aussi à la fonctionnalité de pagination au design personnalisable, ce qui est essentiel pour ce projet. Pour une meilleure optimisation j'ai adapté l'image respective aux différents breakpoints (mobile , tablette, bureau) à chaque slide. On peut rajouter facilement un slide via le fichier slides.js qui est un tableau d'objet js et dont le composant Slider va mapper lors du montage pour créer le slider.",
                        ]
                    },
                ],
                linksWebsites: [

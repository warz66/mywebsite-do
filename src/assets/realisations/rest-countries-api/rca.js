                ...
                sections: [
                    {
                        paragraphe: [
                            ...
                            "Pour ce qui est de pouvoir faire du rendu côté serveur (SSR-server side rendering), nottamment pour répondre à des problématiques d'optimisation de référencemenent pour les moteurs de recherche, les deux technologies ont leurs propres solutions, Nuxt pour Vue et Next pour React. J'ai pratiqué un peu sur ces deux Frameworks, mais je n'ai pas encore le recul pour les différenciés.",

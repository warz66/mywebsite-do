...
const clp = [
    {   
        ...
        image: {
            thumbnail: clipboardRealisation,
            large: clipboardRealisation,
        },
        techs: "HTML / CSS",
        ...
        presentation: [
            ...
            "- Reproduire le plus fidèlement la maquette.<br>- Afficher la mise en page optimale en fonction de la taille de l'écran.<br>- Voir les états de survol pour tous les éléments interactifs du site."
        ],
        linkGithub: "https://github.com/warz66/FMentor-ClipboardLandingPage",
        linkWebsite: "https://warz66.github.io/FMentor-ClipboardLandingPage",
    },
]

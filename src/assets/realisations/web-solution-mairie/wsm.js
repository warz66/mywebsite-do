...
const wsm = [
    {   
        ...
        presentation: [
            "Projet personnel ayant pour but d'apprendre le framework Symfony 5. Cela m'a permis d'appréhender le champ de développement d'une application web dans son ensemble, du front-end au back-end jusqu'à la mise en production. Symfony nous donne un cadre de travail (règles métier, architecture, composants) afin d'être plus efficace, de ce concentré sur l'essentiel et de produire un code de meilleure qualité. Le monde du dev web peut-être déboussolant par la multitude de technologies qu'il comporte, Symfony nous dirige, nous rassure et nous conforte dans notre travail. Les sources qui m'ont grandement aidé à apprendre Symfony et mettre en place ce projet en dehors de la documentation officiel viennent essentiellement de formation vidéo de Lior Chamla, de Grafikart, de cours OpenClassRoom ainsi que de livres.",
            "Pour la plupart des problématiques d'un projet, un CMS tel que Wordpress, Drupal et bien d'autres peuvent largement convenir, néanmoins, j'avais envie de coller au plus près de la conception de ce que peut-être un CMS en créant une solution sur-mesure qui répondrait aux besoins 'précis' des collectivités. Cette solution ne vise que les communes de moins de 30 000 habitants qui représente la majorité (99 %) de l'ensemble des communes de France. Ce sont surtout des sites qui permettent le partage des informations relatives à la vie de la commune au plus grand nombre de personnes, sous forme d'actualités, d'événements ou de pages informatives. Des fonctionnalités me paraissaient essentielles, tel qu'un carousel sur la homepage, un 'flash infos', un kiosque de diffusion de documents, des liens rapides vers du contenu essentiels, une barre de recherche, des galeries d'images, une newsletter, un formulaire de contact, et bien évidemment un back-office accessible à des néophytes."
        ],

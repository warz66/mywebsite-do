        ...
        specs: [
            ...
            },
            {
                ...
                sections: [
                    {
                        paragraphe: [
                            "L'un des besoins principal de ce projet est de pouvoir ajouter simplement dans le temps les nouveaux projets réalisés. Pour cela, j'ai pour office de base de données, un ensemble de répertoires/fichiers, contenant des objets javascript avec une structure clé-valeur prédéfinit lu par l'application pour en afficher le contenu de la façon désiré. Un fichier realisationsMap.js est le point d'entrée de l'ensembles des projets et dont le contenu est une briève présentation que l'on retrouve sous forme de 'cartes' dans la section réalisation de la Homepage. Grâce à <a href='https://vercel.com/docs/concepts/git/vercel-for-github' target='_blank' rel='noreferrer'>Vercel</a> le site est instantanément mis à jour après avoir poussé (git push) les nouvelles modifications sur le dépôt. En respectant cette 'organisation' cela permet facilement d'ajouter un projet au site."
                        ]
                    },
                ],
                linksWebsites: [
